  ...
  if(isset($_GET['tk'])){//nếu gửi ấn 1 nút
    ...
    if($_GET['tk']=='chuanop'){ //hiển thị ds chưa nộp
      ?> <div class="block">
            ...
            <div class="form">
              <form method="post" action="">
                <label>Ngày</label><input type="text" name="ngay" placeholder="1-31"><br>
                <label>Quí</label><input type="text" name="qui" placeholder="1-4"><br>
       ...
       ?><div class="block">
            ...
            <div class="form">
              <form method="post" action="">
                <label>Ngày</label><input type="text" name="ngay" placeholder="1-31"><br>
                <label>Quí</label><input type="text" name="qui" placeholder="1-4"><br>
                <label>Năm</label><input type="text" name="nam" placeholder="Lớn hơn tháng 11/2016"><br><br>
                <p>Nếu muốn xem danh sách theo cả quí vui lòng để trống trường ngày</p><br><br>
                <button name="submit"class="button"><span>Xem Ngay</span></button>
              </form>
            </div>
